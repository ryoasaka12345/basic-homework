...
/*
<problem>
Write a query to extract the data from the orders table 
for those agents who erned the maximum commision.

<solution>
1. Get maximum commision
2. Get all agents have same maximum commision
3. Get all orders of the age
 */

SELECT ORD_NUM, ORD_AMOUNT, ADVANCE_AMOUNT, AGENT_CODE
FROM orders
WHERE AGENT_CODE IN(
  SELECT AGENT_CODE
  FROM agents 
...
for agents who have freater than or equal to two 'customer'.
